...
//                        sh "scp -q -i /usr/share/jenkins/tomcat_server_key.pem **/target/*.war ec2-user@${params.tomcat_dev}:/var/lib/tomcat7/webapps"
                        sh "scp -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no -i /var/lib/jenkins/.ssh/tomcat_server_key.pem /home/ubuntu/tt ec2-user@54.89.180.59:/home/ubuntu"
                    }
                }
